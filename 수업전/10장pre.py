...
print('노트의 전체 페이지수', wise_saying_notebook.get_number_of_all_pages())
...
print('노트의 전체 페이지수', wise_saying_notebook.get_number_of_all_pages())
print('노트의 전체 글자수', wise_saying_notebook.get_number_of_all_characters())
...
wise_saying_notebook.print_all()